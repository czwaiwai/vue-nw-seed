  ...
  begin
    ...
    if CurPageID = wpFinished then
      begin
        ...
        // 是否自动运行
        checkboxAutoRun:=BtnCreate(WizardForm.Handle,200,400,16,16,ExpandConstant('{tmp}\checkbox.png'),1,true)
        labelAutoRunImg:=ImgLoad(WizardForm.Handle,ExpandConstant('{tmp}\label_autorun.png'),220,398,84,20,false,true);
