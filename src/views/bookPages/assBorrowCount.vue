    ...
    <div>
      ...
      <div class="grid-x">
        ...
        <div class="cell small-4 ">
          <el-button @click="exportExcel('/ycBook/assBorrowCountExp')" :loading="exportLoading" type="primary" plain size="small">数据导出</el-button>
        </div>
      </div>
      <div  v-loading="isLoading" >
        <el-table :data="list" style="width:500px;" >
          <el-table-column type="index"  align="center" label="序号" width="80" ></el-table-column>
          <el-table-column prop="saleName" align="center" label="店员姓名" ></el-table-column>
...
<script type="text/ecmascript-6">
  ...
  export default{
    ...
    created () {
      this.url = '/ycBook/assBorrowCount'
    }
  }
</script>
